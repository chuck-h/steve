<form:form action="${ctxPath}/manager/operations/${opVersion}/RemoteStartTransaction" modelAttribute="params">
    ...
    <table class="userInput">
		...
		<tr id="ChargingProfile" class="header expand" style="display:none;" >
			...
			<td><form:checkbox path="useChargingProfile" /></td>
		</tr>
		...
		<tr data-for="ChargingProfile" style="display:none" class="header expand" id="cp"><td class="noselect"><b>Charging Profile <span class="sign" /></b></td></tr>
		...
		<tr data-for="ChargingProfile" style="display:none" class="header expand" id="cs"><td class="noselect"><b>Charging Schedule <span class="sign" /></b></td></tr>
		...
		<tr data-for="ChargingProfile" style="display:none" class="header expand" id="csp"><td class="noselect"><b>Charging Schedule Period <span class="sign" /></b></td></tr>
